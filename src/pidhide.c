...
static const struct argp_option opts[] = {
	{ "pid-to-hide", 'p', "PID-TO-HIDE", 0,
	  "Process ID to hide. Defaults to this program" },
	{ "target-ppid", 't', "TARGET-PPID", 0,
...
int main(int argc, char **argv)
{
	...
	strncpy(skel->rodata->pid_to_hide, pid_to_hide,
		sizeof(skel->rodata->pid_to_hide));
